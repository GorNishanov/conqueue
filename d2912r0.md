...
### Expected is the only way

One of the option suggested was to eliminate throwing version of APIs completely and collapse them into a single expected returning version
```c++
```

<table>
  <tr>
    <th>throwing usage</th>
    <th>non-throwing usage</th>
  </tr>
  <tr>
    <td>
<pre>
