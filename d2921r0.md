...
This paper explores extending interface of Buffered Queue (https://wg21.link/p0260r7) with APIs
...
// do something else
```
The surprising observation we can make is that expected based API 
do not appear to be a clear cut winners and only offer 
...
2. [p0260r7: A proposal to add a concurrent queue
   to the standard library](https://wg21.link/p0260r7)
